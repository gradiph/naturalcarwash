			...
			<div class="col-sm-10 col-md-8 col-lg-6 mx-auto">
				<div class="card">
					<div class="card-header">
						Ubah Mekanik {{ $mechanic->name }}
					</div>
					<div class="card-body">
						<form action="{{ route('mechanics.update', ['mechanic' => $mechanic->id]) }}" method="post" id="updateMechanicForm" role="form">
							{{ csrf_field() }}
							{{ method_field('put') }}
							...
							<div class="form-group row">
								...
								<div class="col-8">
									<input type="text" id="inputname" name="name" value="{{ old('name', $mechanic->name) }}" class="form-control" required autocomplete="off">
									@if($errors->has('name'))
					...
					<div class="card-footer text-right">
						<button type="submit" id="submit-btn" form="updateMechanicForm" class="btn btn-primary">
...
<script>
	...
	$("#updateMechanicForm").submit(function() {
